...
## Project Structure
    ...
    ├── testapiautoconnecto_94437  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_94437`
...
2. Clone this repo and `cd testapiautoconnecto_94437`
